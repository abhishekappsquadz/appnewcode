...
$query = "SELECT * from app_reviews order by id desc limit $lim,3";
...
foreach($testimonals as $testimonal) {
                        ...
                        <div class="col-md-4 col-sm-4 col-xs-12 count-list">
                            <div class="nd-testimonial-block transition text-center">
                                <div class="tm-project-logo"><img src="<?php echo $final.'uploads/client_profile/'.$testimonal['client_profile'];?>" style="" class="" onerror="imgError(this);" alt="SnaPak" style="width: 100px; height: 100px;"></div>
                        ...
                        <div class="col-md-4 col-sm-6 count-list">
                            <div class="nd-testimonial-block transition text-center">
                                <div class="tm-project-logo">
                                    ...
                                    <img src="<?php echo $final.'uploads/client_profile/'.$testimonal['client_profile'];?>"  class="" onerror="imgError(this);" alt="Readers Rescue" style="width: 100px; height: 100px;">
                                </div>
                                <div class="tm-project-name fbold"><?php echo $testimonal['client_name']; ?></div>
                                <div class="tm-client-post fsemibold"><?php echo $testimonal['client_company_name']; ?>, <?php echo $testimonal['designation']; ?></div>
                                <div class="tm-star">
								...
								<img src="<?php echo $validate_image; ?>" alt="validater logo" width="115px" height="35px"></div>
                                <div class="tm-button">
