        ...
        <section class="innerpage-banner selected custom-banner" style="background:url(img/banners/career-detail-bnr.png) no-repeat center top;  background-size: cover;">
            <div class="container">
                <div class="in-banner-content career-banner-pd fadeInUp animated3">
                    <div class="careeBnrIcon"><span class="careerIcon bde transition "></span></div>
                    <h1>Business Development Executive</h1>
                    <p>Pre-sales scenes!</p>
            ...
            <div class="container">
                <div class="col-md-12">
                    <div class="process-blue-block aw-cl-logo-con">
                        <div class="col-md-12">
                            <div class="row">
                                <h2>You pro-fit into the tech-frame of our business if you can pitch it into the buying-zone of client.</h2>
                                <p class="marT15">If you have that knack of cracking the trickiest of deals with sulkiest of clients – plug-in to the best of tech settings with friendliest of sales recognition and reward agendas. Sure, you would love the way we put up with sales as you get to work with the finest of teams and processes!</p>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <ul>
                        ...
                        <li>
                            <div class="loc-col">
                                ...
                                <div class="location_Name">Department <span>Sales</span></div>
                            </div>
                        </li>
                        <li>
                            <div class="loc-col">
                        ...
                        <li>
                            <a href="cdn-cgi/l/email-protection.html#c5adb785aeaaabb6b1a4abb1acaba3aaeba6aaa8" class="apply_Now_btn">Apply Now</a>
                        </li>
                    </ul>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-sm-6">
                    <div class="duties">
                        ...
                        <ul>
                            <li>Researching business opportunities online to identify new leads and potential new markets</li>
                            <li>Commit to targets and impact and execute sales</li>
                            <li>Planning and managing new marketing initiatives</li>
                            <li>Producing sales documents and proposals in coordination with technical teams</li>
                            <li>Contacting potential clients via email or phone to establish rapport and set up meetings</li>
                            <li>Establishing and facilitating effective communication across the board</li>
                            <li>Contacting clients to inform them about new developments in the company’s products</li>
                        </ul>
                    </div>
                </div>
                <div class="col-sm-6">
                    <div class="duties">
                        ...
                        <ul>
                            <li>Should have the flair for sales </li>
                            <li>Can prepare impactful PowerPoint presentations and sales displays</li>
                            <li>Should be fluent in written and verbal communication </li>
                            <li>Familiar with developing quotes and proposals</li>
                            <li>Should be able to work in a dynamic work environment and with cross-functional teams</li>
                            <li>Should coordinate with the team to accomplish sales goals</li>
                        </ul>
                    </div>
                </div>
            </div>
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            ...
                            <div class="col_bottom">
                                <a href="cdn-cgi/l/email-protection.html#462e34062d292835322728322f2820296825292b" class="apply_btn1 transition">Apply Now</a>
