...
<html lang="en" itemscope itemtype="http://schema.org/WebPage">
  ...
  <body itemscope itemprop='mainEntity' itemtype='http://schema.org/Organization' class=''>
    ...
    <section class="pastPerformance" id="caseStudyLoadSection">
      <div class="container">
        <div class="main-content-block fadeInUp animated3">
          <h2>DEVELOPING APPLICATIONS | CURATING EXPERIENCES</h2>
          <div class="title-bar">
            We move forward with a strong vision taking along with us our past experiences which lead to development 
            of engaging mobile applications with high ROI and maximum conversions
          </div>
        </div>
        <div class="row">
                ...
                <div class="row">
                    ...
                    <div class="service_flipbox">
                      <div class="flipbox_font">
                        <div class="inner_flip">
                          <div class="img-block mobile"><img src="img/icons/1.png"></div>
                      ...
                      <div class="flipbox_back">
                        <div class="inner_flip features-section">
                          <h4>Mobile Applications &amp; Wearables</h4>
                          <p>Integrating various arenas for a connected future through iOS and Android applications.</p>
                          <ul class="list">
                  ...
                  <div class="col-md-4">
                    <div class="service_flipbox">
                      <div class="flipbox_font">
                        <div class="inner_flip">
                          <div class="img-block web"><img src="img/icons/2.png"></div>
                  ...
                  <div class="col-md-4">
                    <div class="service_flipbox">
                      <div class="flipbox_font">
                        <div class="inner_flip">
                          <div class="img-block cart"><img src="img/icons/3.png"></div>
                  ...
                  <div class="col-md-4">
                    <div class="service_flipbox">
                      <div class="flipbox_font">
                        <div class="inner_flip">
                          <div class="img-block mobile"><img src="img/icons/4.png"></div>
                  ...
                  <div class="col-md-4">
                    <div class="service_flipbox">
                      <div class="flipbox_font">
                        <div class="inner_flip">
                          <div class="img-block cart"><img src="img/icons/5.png"></div>
                  ...
                  <div class="col-md-4">
                    <div class="service_flipbox">
                      <div class="flipbox_font">
                        <div class="inner_flip">
                          <div class="img-block cart"><img src="img/icons/6.png"></div>
                ...
                <div class="row">
                  <div class="col-md-offset-2">
                    ...
                    <p class="success-point whiteText blacktextsecondp">
                      ...
                      <span class="section-subtitle poppinsMediumFont text-black">on app store</span>
                      <span class="section-description poppinsRegularFont text-black">under <b>Education</b> category</span>
                    </p>
                    <p class="success-point whiteText">
                      <span class="section-subtitle poppinsMediumFont text-black">5 Million +</span>
                      <span class="poppinsSemiboldFont font30 text-black">downloads</span>
                      <span class="section-description poppinsRegularFont text-black">& still counting...</span>
                    </p>
                    <div class="tm-star">
                      <ul>
                      ...
                      <span class="section-description poppinsRegularFont text-darkgrey"><b>5.0/5.0 on Clutch review</b></span>
                    </div>
                    <div class="icon-block">
                      <ul style="display: block; top: 72px; position: relative;">
          ...
          <div class="table">
            <div class="table-cell" >
              <div class="container-fluid">
                <div class="row">
                  <div class="col-md-offset-2">
                    <h4 class="purpleText section-subtitle poppinsMediumBold margin-bottom20 blacktext">Amar Ujala</h4>
                    ...
                    <br>
                    <p class="success-point whiteText">
                      <span class="poppinsSemiboldFont font30 text-black">Featured app</span>
                      <span class="section-subtitle poppinsMediumFont text-black">on app store</span>
                      <span class="section-description poppinsRegularFont text-black">No.#1 News Paper app in India</span>
                    </p>
                    <p class="success-point whiteText">
                      <span class="section-subtitle poppinsMediumFont text-black">1 Million +</span>
                      <span class="poppinsSemiboldFont font30 text-black">downloads</span>
                      <span class="section-description poppinsRegularFont text-black">& still counting...</span>
                    </p>
                    <div class="tm-star">
                      ...
                      <span class="section-description poppinsRegularFont text-darkgrey"><b>4.9/5.0 on Clutch review</b></span>
                      <div class="icon-block">
                        <ul style="display: block; top: 72px; position: relative;">
                          <li><span class="cib-tooltip">Website</span><a href="http://www.thesmartlink.com.au/" target="" title="" class="web-icon"></a></li>
                          <li><span class="cib-tooltip">iPhone</span><a href="https://itunes.apple.com/au/app/the-smartlink/id1105845010?mt=8" target="" title="" class="apple-icon"></a></li>
              ...
              <div class="container-fluid">
                <div class="row">
                  <div class="col-md-offset-2">
                    ...
                    <br>
                    <p class="success-point whiteText">
                      <span class="poppinsSemiboldFont font30 text-black">Survey App</span>
                      <span class="section-subtitle poppinsMediumFont text-black">on app store</span>
                      <span class="section-description poppinsRegularFont text-black">in 'Best New Apps'</span>
                    </p>
                    <p class="success-point whiteText">
                      <span class="section-subtitle poppinsMediumFont text-black">European Design</span>
                      <span class="poppinsSemiboldFont font30 text-black">Award Winner</span>
                      <span class="section-description poppinsRegularFont text-black"></span>
                    </p>
                    <div class="tm-star">
                      <ul>
                        <li> <a href="javascript:void(0)" class="active"><i class="fa fa-star" aria-hidden="true"></i></a> </li>
                      ...
                      <span class="section-description poppinsRegularFont text-darkgrey"><b>5.0/5.0 on GoodFirms review</b></span>
                    </div>
                    <div class="icon-block">
                      <ul style="display: block; top: 72px; position: relative;">
                        <li><span class="cib-tooltip">Website</span><a href="http://www.thesmartlink.com.au/" target="" title="" class="web-icon"></a></li>
    ...
    <div class="container" style ="background :#fff">
      <div class="in-banner-content-home main-content-block fadeInUp animated3" >
        <span class="sub_text text-black">See how we’ve delivered best results to our smartest clients</span>
        <h2>OUR CASE STUDIES IN DETAIL</h2>
        <div class="title-bar">Below are some recently updated case studies involving our web design, mobile app development, eCommerce, 
          <br />on-demand, IoT, wearable, cloud services etc.
        </div>
      </div>
    </div>
    ...
    <section class=press-release>
      <div class=container>
        <div class="main-content-block rows fadeInUp animated3">
          <h2 class="text-uppercase">Proud Releases</h2>
