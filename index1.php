...
<html lang="en" itemscope itemtype="http://schema.org/WebPage">
   ...
   <head>
      ...
      <link rel="canonical" href="https://www.appsquadz.com/index.html" />
      ...
      <script type="text/javascript" async src="js/responsiveCarousel.min.js"></script><!--slider-->
   ...
   <body itemscope itemprop='mainEntity' itemtype='http://schema.org/Organization' class=''>
      ...
      <div class="start-a-project rq-ud-form closed">
         ...
         <p class="pinned--bottom-right">
            Or send us an email at: <a href="cdn-cgi/l/email-protection.html#e291838e8791a2898d8c9196838c968b8c848dcc818d8f"><span class="__cf_email__" data-cfemail="b2c1d3ded7c1f2d9dddcc1c6d3dcc6dbdcd4dd9cd1dddf">sales@appsquadz.com</span></a>
         </p>
               ...
               $('#inquire_quote_files').on("change", function(event) {
                  ...
                  if(!window.File && window.FileReader && window.FileList && window.Blob){ //if browser doesn't supports File API
                     ...
                     if(proceed){
                        ...
                        //jQuery Ajax to Post form data
                        $.ajax({
                           url: "https://www.appsquadz.com/contacts/upload",
                           type: "POST",
                           data : form_data,
                           contentType: false,
                           cache: false,
            ...
            <div class="mainsec">
               <h1 id="content-bg" style="line-height: 74px; margin-top: -60px;">
                  <span class="aletest">
                     ...
                     <div class="overlay">
                        <a href="#"><img src="img/welcomeplay.svg" style="margin-left: 0px; margin-top: -20px;"></a>
                     </div>
                  </span>
                  are
                  <span class="aletest">
               ...
               <p>Our aim is to deliver as our customers desire. Our company’s passion is to build mobile applications and that reflects in our work. We develop enriching, engaging and user-friendly mobile applications and provide fulfilling web solutions which consist of intuitive UX, recent technology and state of the art interfaces.
               <br><b>We are 650+ projects young and have delivered in almost 30+ countries</b></p>
               <!--    <div class="row">
                  <div class="col-sm-3 col-md-3 col-xs-3">
                  <div class="left-arrow"></div>
                  </div>
                  <div class="col-sm-6 col-md-6 col-xs-6">
                    <div class="techslid" style="margin-left: 115px;">
                    <h2 style="float: left;">We are great at:</h2>
                    <div class="diapo" style="float: left;">
                    <ul class="slide">
                      <li class="diapo1">Android</li>
                      <li class="diapo2">iOS</li>
                      <li class="diapo3">HTML 5</li>
                      <li class="diapo3">Windows</li>
                      <li class="diapo3">JScript</li>
                      <li class="diapo3">PHP</li>
                    </ul>
                  </div>
                  </div>
                     </center>
               ...
               <div class="btn-section_work">
                  <a href="portfolios.html" class="latest_work_btn headerestimate">RECENT PROJECTS GET AN ESTIMATE IN A GLANCE</a>
                  <a href="app_price_calculator.html" class="latest_work_btn headerestimate">Get an Estimate</a>
               </div>
            </div>
         </div>
         <!-- <div class="container-fluid">
            <div class="floating-form" id="contact_form" style="float: right; margin-right: 70px; ">
              <div class="contact-opener" ><img class="faa-ring animated" src="img/phone.png" alt="Phone">
              </div>
              <div id="callvack_results">
      ...
      <section class="pastPerformance" id="caseStudyLoadSection">
         <div class="container">
            <div class="fadeInUp animated3">
               <h3><span>DEVELOPMENT ASSURANCE</span></h3>
            ...
            <div class="row">
               ...
               <div class="col-sm-4 zoomIn animated3 delay3">
                  <div class="resultBlock">
                     <div class="resultTitle titleOrange"><span class="count">73</span>%</div>
                     <p>Repeat Business</p>
                  </div>
               </div>
            </div>
            <div class="row">
               <div class="col-sm-4 zoomIn animated3 delay1">
                  <div class="resultBlock">
                     <div class="resultTitle titlePur"> <span class="count">650</span>+</div>
                     <p>Apps Developed By AppSquadz Team</p>
                  </div>
               </div>
               <div class="col-sm-4 zoomIn animated3 delay2">
                  <div class="resultBlock">
                     <div class="resultTitle titleOrange1"><span class="count">5</span>%</div>
                     <p>Awards in IT</p>
                  </div>
               </div>
               <div class="col-sm-4 zoomIn animated3 delay3">
                  <div class="resultBlock">
                     <div class="resultTitle titleBlue"><span class="count">97</span>%</div>
      ...
      <!--  <div class="container">
         <div class="main-content-block rows fadeInUp animated3">
           ...
           <div class="row">
             <div class="development-experieance-1">
               <h2><strong>12+ YRS<br></strong></h2>
               <div style="">Development Experience</div>
             </div>
             <div class="development-experieance-2">
               <ul>
                 <li class="devheadsec"><h2>Talented</h2><h2 style="font-size: 32px;">Developer</h2></li>
                 <li class="devhead"><h2>100+</h2></li>
               </ul>
             </div>
             <div class="development-experieance-3">
               <ul>
                 <li class="devhead"><h2>73%</h2></li>
                 <li class="devheadsec"><h2>Repeat</h2><h2>Business</h2></li>
               </ul>
             </div>
             <div class="development-experieance-4">
                <ul>
                 <li class="devheadsec"><h2  style="font-size: 60px; margin-top: 45px;">Total</h2><h2>Projects</h2></li>
                 <li class="devhead"><h2>650+</h2></li>
               </ul>
             </div>
             <div class="development-experieance-5">
              <h2><strong></strong> </h2>
             <ul>
                 <li class="devheadsec"><h2  style="font-size: 60px; margin-top: 32px;">Got</h2><h2>Awards</h2></li>
                 <li class="devhead"><h2>05</h2></li>
               </ul>
             </div>
             <div class="development-experieance-6">
               <ul>
                 <li class="devhead"><h2>97%</h2></li>
                 <li class="devheadsec"><h2 style="font-size: 25px; margin-top: 32px;">Projects Delivered</h2><h2>ON TIME</h2></li>
               </ul>
             </div>
           </div> 
         </div>
      ...
      <section class="features-block of-hidden">
         <div class="container">
            <div class="main-content-block rows fadeInUp animated3">
               <h2>Company</h2>
               <div class="title-bar">Developing apps that delight millions of people</div>
            ...
            <div class="features-section deliver rows">
               <div class="col-md-12">
                  <div id="col-manage-block-heights1" class="row">
                     <div class="col-md-4">
                        <div class="feature-block col-block-height transition active">
                           <div class="img-block mobile"><i class="careerIcon mobW transition">&nbsp;</i></div>
                     ...
                     <div class="col-md-4">
                        <div class="feature-block col-block-height transition">
                           <div class="img-block web"><i class="careerIcon webD transition">&nbsp;</i></div>
                           <div class="content-part">
                     ...
                     <div class="col-md-4">
                        <div class="feature-block col-block-height transition">
                           <div class="img-block cart"><i class="careerIcon ed transition">&nbsp;</i></div>
                           <div class="content-part">
                     ...
                     <div class="col-md-4">
                        <div class="feature-block col-block-height transition">
                           <div class="img-block mobile"><i class="careerIcon cloud transition">&nbsp;</i></div>
                           <div class="content-part">
                     ...
                     <div class="col-md-4">
                        <div class="feature-block col-block-height transition">
                           <div class="img-block cart"><i class="careerIcon offshore transition">&nbsp;</i></div>
                           <div class="content-part">
      ...
      <section class="mobile-features-tabing" id=leading-sec>
         <div class=leading-sec>
            <div class="in-banner-content-home1 fadeInUp animated3" >
               <h1  style ="color :#fff" >RECOGNITION BY INDUSTRY LEADRES</h1>
            </div>
            <div class="clear"></div>
                     ...
                     <div class="container-fluid">
                        <div class="row">
                           <div class="col-md-offset-2">
                              ...
                              <p class="opensanseRegularFont text111 section-description margin-bottom20 blacktextp">Creator is a fast, beautiful and fun way to share your creation with the world. Whether you are a designer, photographer, artist or just a creative mind, take a picture, tell your story and post it to CREATOR – it's that easy.</p>
      ...
      <section class="caseStudySec">
            ...
            <div class="col-md-6 col-md-push-6-home">
               <div class="caseSec">
                  <div class="caseImgHome" >
                     <div class="caseName" style="border-top: 1px solid #1866b1;">
                        <h1 style="font-size:45px; color:#000"><b>GRAB TAXI</b></h1>
                        <span style="font-size:30px;margin-top:-10px ;  color:#000">$700 Million Fund Raised</span>
                        <span style="margin-top:-10px;  font-size:20px; color:#000">Aaron Gill , Head of Product</span>
                        <a href="case-study/grab-taxi-case-study.html" class="viewCaseBtnWhite transtition">Open Case Study</a> 
                     </div>
                  </div>
         ...
         <div class="row">
            ...
            <div class="col-md-6 col-md-push-6-home">
               <div class="caseSec">
                  <div class="caseImgHome" >
                     <div class="caseName">
                        <h1 style="font-size:45px;color:#000"><b>LOVO - Free Dating</b></h1>
                        <span style="font-size:30px;margin-top:-10px;color:#000">10 Million+ Downloads</span>
                        <span style="margin-top:-10px;color:#000; font-size:20px;">Mario Sorge , Adroid Engineer</span>
                        <a href="case-study/lovoo-case-study.html" class="viewCaseBtnWhite transtition">Open Case Study</a> 
                     </div>
                  </div>
                  <div class="caseSec_overlay" style=" background-color: #fff;"></div>
               </div>
         ...
         <div class="row">
            <div class="col-md-6 col-md-push-6-home">
               <div class="caseSec">
                  <div class="caseImgHome" >
                     <div class="caseName" style="border-bottom: 1px solid #1866b1;">
                        <h1 style="font-size:45px;color:#000"><b>TUPELO LIFE</b></h1>
                        <span style="font-size:30px;margin-top:-10px;color:#000">No.#1 Health &amp; Fitness App in UAE</span>
                        <span style="margin-top:-10px;color:#000; font-size:20px;">Sachin Kumar - Chief Technology Officer</span>
                        <a href="case-study/tupelo-life-case-study.html" class="viewCaseBtnWhite transtition">Open Case Study</a> 
                     </div>
                  </div>
      ...
      <section class="pastPerformance" id="caseStudyLoadSection">
         <div class="container">
            <div class="fadeInUp animated3">
               <img alt="Success Icon" src="img/success-icon.png" />
               <h3><span>We deliver </span>impressive results</h3>
               <p>Clients have not just been happy but delighted with our top-notch service offerings. Our past experiences lead the way to visionary results that generate high ROI and maximum conversions.</p>
            </div>
            <div class="row">
               <div class="col-sm-4 zoomIn animated3 delay1">
                  <div class="resultBlock">
                     <div class="resultTitle titleGreen"> <span class="count">650</span>+</div>
                     <p>Apps Developed By AppSquadz Team</p>
                  </div>
               </div>
               <div class="col-sm-4 zoomIn animated3 delay2">
                  <div class="resultBlock">
                     <div class="resultTitle titlePurpel"><span class="count">74</span>%</div>
                     <p>Client Retention Rate</p>
                  </div>
               </div>
               <div class="col-sm-4 zoomIn animated3 delay3">
                  <div class="resultBlock">
                     <div class="resultTitle titleOrange"><span class="count">2800</span>+</div>
                     <p>Businesses Served Worldwide</p>
                  </div>
               </div>
            </div>
         </div>
      ...
      <section class="development-process-block" style="margin-top: -56px;">
         <div class="container">
            <div class="main-content-block rows fadeInUp animated3">
               <h2>AppSquadz Development Process</h2>
               ...
               <ul class="nav nav-tabs" role="tablist">
                  <li role="presentation" class="first-tab active">
                     <div class="center-block"> <a href="#discovery" role="tab" data-toggle="tab"> <i class="search"></i> <br>
                        <span class="transition">Discovery</span> </a> 
                     </div>
                  </li>
                  ...
                  <li role="presentation" class="third-tab">
                     <div class="center-block"><a href="#release-planning" role="tab" data-toggle="tab"> <i class="list"></i> <br>
                        <span class="transition">Release Planning</span> </a>
                     </div>
                  ...
                  <li role="presentation" class="fouth-tab">
                     <div class="center-block"><a href="#development" role="tab" data-toggle="tab"> <i class="wrench-tool"></i> <br>
                        <span class="transition">Development</span> </a>
                     </div>
                  </li>
                  <li role="presentation" class="five-tab">
                     <div class="center-block"><a href="#final-lunch" role="tab" data-toggle="tab"> <i class="paper-plane"></i> <br>
                        <span class="transition">Final UAT + Launch</span> </a>
                     </div>
                  </li>
               </ul>
            </div>
               ...
               <div class="tab-pane active cus-fadeInUp animated3" id="discovery">
                  <div class="container">
                     <div class="main-content-block">
                        <p>As a full-service mobile development agency, our process begins with an 
                          In-depth, comprehensive research on the client’s idea, which lays the groundwork for every project we develop. To grasp our concept and broaden our horizons we constantly interact with clients. This helps us align ourselves with their team leading us torecogniseand associate their business goal so that we can deliver a quality service. The first step is all about setting the stage for a big, innovative solution.</p>
      ...
      <div id="industries" class="industries-section ">
         <!-- <div class="container">
            <div class="main-content-block rows">
               <h2>Diverse experiences across several industries</h2>
               <div class="title-bar">A Multi-Asset Team of Innovators</div>
               <p>For your app to succeed, you need a team of smart business strategists, creative UI/UX designers, and proficient mobile developers. And you've come to the right source. In the glut of ho-hum mobile apps, we don't settle for good but shoot for amazing, and that’s where we can take you.</p>
            </div>
            </div> -->
         <!--  <section class="industries-design-block">
            <div class="container">
               <div class="animation-slide-links">
                  <div class="ani-link ani-link1 fadeInUp animated4 delay1"><i class="zoomIn animated3 delay2"></i><a href="real-estate-property.html" class="animated3 zoomIn delay3">Real Estate <br />&amp; Property </a></div>
                  <div class="ani-link ani-link2 fadeInUp animated4 delay1"><i class="zoomIn animated3 delay2"></i><a href="education-elearning.html" class="animated3 zoomIn delay3">Education</a></div>
                  <div class="ani-link ani-link3 fadeInUp animated4 delay1"><i class="zoomIn animated3 delay2"></i><a href="on-demand-app-development.html" class="animated3 zoomIn delay3">On-demand</a></div>
                  <div class="ani-link ani-link4 fadeInUp animated4 delay1"><i class="zoomIn animated3 delay2"></i><a href="banking-finance.html" class="animated3 zoomIn delay3">Banking,<br />Finance &amp; Insurance</a></div>
                  <div class="ani-link ani-link5 fadeInUp animated4 delay1"><i class="zoomIn animated3 delay2"></i><a href="dating-social-networking.html" class="animated3 zoomIn delay3">Social Networking</a></div>
                  <div class="ani-link ani-link6 fadeInUp animated4 delay1"><i class="zoomIn animated3 delay2"></i><a href="healthcare-fitness.html" class="animated3 zoomIn delay3">Healthcare</a></div>
                  <div class="ani-link ani-link7 fadeInUp animated4 delay1"><i class="zoomIn animated3 delay2"></i><a href="event-tickets-portal-development.html" class="animated3 zoomIn delay3">Events &amp; Tickets</a></div>
                  <div class="ani-link ani-link8 fadeInUp animated4 delay1"><i class="zoomIn animated3 delay2"></i><a href="automotive-transportation.html" class="animated3 zoomIn delay3">Transport</a></div>
                  <div class="ani-link ani-link9 fadeInUp animated4 delay1"><i class="zoomIn animated3 delay2"></i><a href="ecommerce-shopping.html" class="animated3 zoomIn delay3">Ecommerce, <br />Retail &amp; B2B</a></div>
                  <div class="ani-link ani-link10 fadeInUp animated4 delay1"><i class="zoomIn animated3 delay2"></i><a href="gaming-leisure.html" class="animated3 zoomIn delay3">Gaming &amp; Leisure</a></div>
                  <div class="ani-link ani-link11 fadeInUp animated4 delay1"><i class="zoomIn animated3 delay2"></i><a href="food-restaurant.html" class="animated3 zoomIn delay3">Food &amp; <br />Restaurant</a></div>
                  <div class="ani-link ani-link12 fadeInUp animated4 delay1"><i class="zoomIn animated3 delay2"></i><a href="travel-hospitality.html" class=" animated3 zoomIn delay3">Travel &amp; Hospitality</a></div>
               </div>
            </div>
            </section> -->
      ...
      <section class="home-portfolio-block">
         <div class="main-content-block fadeInUp animated3">
            <h2>Few of our recent favorite projects</h2>
            <div class="title-bar">Let our work speak for itself</div>
         </div>
         <div id="w">
            <br>
            <div class="container">
               ...
               <div class="crsl-items fadeInUp animated3" data-navigation="navbtns">
                  <div class="crsl-wrap">
                     <div class="crsl-item">
                        <div class="mobile-porfolio-grid transition round10" data-id="24">
               <div class="mobile-client-logo">
                    <img src="http://localhost/appsquadz/uploads/app_logos/Taste of Bihar.png" style="" class="" onerror="" alt="LUV ViD">
               </div>
               <div class="mobile-client-name">Taste Of Bihar</div>
               <div class="mobile-clientProject">Marketing &amp; Classified</div>
               <div class="text-center devices mobile">
                  <div>
                     <img src="http://localhost/appsquadz/uploads/app_thumb_image/Taste-of-Bihar.png" style="" class="" onerror="" alt="Taste Of Bihar"> 
                  </div>
               </div>
               <div class="mobilegrid-hover">
                  <div class="mobileproject-descrption">
                     <div class="mobilep-des-info">
                        <p>pay you money integrated to self-recharge your own shopping card. pay you money integrated to self-recharge your own shopping card.
enhanced user experience. pay you money integrated to self-recharge your own shopping card. pay you money integrated to self-recharge your own shopping card.
enhanced user experience. pay you money integrated to self-recharge your own shopping card. pay you money integrated to self-recharge your own shopping card.
enhanced user experience.</p>
                     </div>
                     <div class="mobile-casestudy" style="display: none"></div>
                     <div class="project-feature-btn">
                        <ul><center>                          <li class="transition"><span><a target="_blank" href="http://tasteofbihar.co.in/">Website</a></span></li>   
                                                      <li class="transition"><span><a target="_blank" href="www.gmail.com">IPHONE</a></span></li>         
                                  
                           <li class="transition"><span><a target="_blank" href="www.google.com">Android</a></span></li>                     </center>   </ul>
                     </div>
                  </div>
               </div>
            </div>
...
enhanced user experience.</p>
         ...
         <div class="btnRow">
            <a href="portfolios.html" class="comman-btn transition">VIEW More PROJECTS</a> 
         </div>
      </section>
      <!-- <script type="text/javascript">
         loadHomePortfolio();
         function loadHomePortfolio(){
          ...
          var action = "https://www.appsquadz.com/app/getHomePortfolio/"+random;
          $.ajax({
            type:"POST",
            url:action,
            data:{},
         ...
         function setPopupdata(portfolioId) {
          var json_data = $('#web_grid_'+portfolioId).find('#portfolio_'+portfolioId).attr('data-attr');
          var parsedJson = $.parseJSON(json_data);
          
          $('#portfolio_background').css('background-image','url(' + parsedJson.bgImage + ')');
          $('#portfolio_background').css('background-color','#'+ parsedJson.background_color);
          $('#portfolio_app').text(parsedJson.name);
          $('#portfolio_indus').text(parsedJson.industryFirstName);
          $('#portfolio_short_desc').html(parsedJson.shot_desc);
          $('#port_tags').html(parsedJson.service_offer_html);
          $('#port_url').html(parsedJson.urls_li);
          $('#port_casestudy').attr('style','display:none !important');
          if($.trim(parsedJson.casestudy_url) != '') {
            $('#port_casestudy').css('display','block');
            $('#port_casestudy').attr('href',parsedJson.casestudy_url);
          }
          $('[id^="portfoliotestimoniala_"]').on('click',function(){
            var self = $(this).parent();
            self.toggleClass( "active" );
          });
          $('#grid_Model').modal('show');
         }
         ...
         var current = '';
         function play_home_portfolio(data){
      ...
      <section id="overflow-slide_5" class="project-delivered-section blue-bg">
         ...
         <script type="text/javascript">
            ...
            function loadTestimonials(ttype){
              ...
              var random = Math.random();
              var action = "#"+random;
              var pageData = 'a:2:{s:11:"headingType";s:8:"homepage";s:17:"showDiscussButton";b:1;}';
              $.ajax({
                type:"POST",
                url:action,
        ...
        <!--  <div class="container">
         ...
         <!-- <ol class="carousel-indicators">
            ...
            <img class="img-responsive " src="img/clients/taxiforsure.jpg" alt="dedicated android app development company">
            <span class="client_name" style="min-height:50px;">
                  <!-- <span class="reference t_in">linkedin</span> -->
         <!-- </span>
            </li>
            <li data-target="#quote-carousel" data-slide-to="1">
            <img class="img-responsive" src="img/clients/Ellen.jpg" alt="dedicated app development">
            <span class="client_name" style="min-height:50px;">
                  <span class="reference t_in">linkedin</span>
                         </span>
            </li>
            ...
            <img class="img-responsive" src="img/clients/Alexis.jpg" alt="android app development company">
            <span class="client_name" style="min-height:50px;">
                  <span class="reference t_in">linkedin</span>--
                         </span>
            </li> -->
         <!-- <li data-target="#quote-carousel" data-slide-to="3">
            <img class="img-responsive" src="img/clients/Christine.png" alt="app development in usa">
            <span class="client_name" style="min-height:50px;">
                  <span class="reference t_in">linkedin</span>--
                         </span>
            </li> 
             <li data-target="#quote-carousel" data-slide-to="4">
            <img class="img-responsive" src="img/clients/James.png" alt="android and ios development company">
            <span class="client_name" style="min-height:50px;">
                  <span class="reference t_in">linkedin</span>--
                         </span>
            </li>
              ...
              <div class="col-md-4 padtop30">
                ...
                <div class="parent_circle_contain">
                    <div class="clint-profile">
                       <img src="img/clients/13.png">
                    </div>
                  <div class="clints-reviews">
                   <br>
                  <div class="tm-project-name fbold khichke-head">Rony Singh</div>
                  <div class="tm-client-post fsemibold khichke-des">Appsquadz,  Designer</div>
                  <div class="tm-star khichke-rate">
                                    <ul>
                               ...
                               <div class="tm-project-discription discription-height">
                                    <p class="flight"><span>"</span> What is Lorem Ipsum? Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s,industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s<span>"</span>
                                    </p>
                                </div>
                  </div>
                </div>
                <br>
                <div class="parent_circle_contain">
                    <div class="clint-profile-large">
                       <img src="img/clients/14.png">
                    </div>
                  <div class="clints-reviews">
                   <br>
                  <div class="tm-project-name fbold khichke-head">Rony Singh</div>
