        ...
        <section class="innerpage-banner selected custom-banner" style="background:url(img/banners/career-detail-bnr.png) no-repeat center top;  background-size: cover;">
            <div class="container">
                <div class="in-banner-content career-banner-pd fadeInUp animated3">
                    <div class="careeBnrIcon"> <span class="careerIcon qa transition "></span></div>
                    <h1>Quality Analyst</h1>
                    <p>It’s all in quality!</p>
                    <div class="btn-section"> <a href="#career-detail-sec" class="comman-btn cbss">see the details</a> </div>
                </div>
            </div>
        </section>
        <section class="support-content-block blue-bg btmarrow custom-support-section pdB37">
            <div class="container">
                <div class="col-md-12">
                    <div class="process-blue-block aw-cl-logo-con">
                        <div class="col-md-12">
                            <div class="row">
                                <h2>In the end, it’s all about quality. And we leave no chance to make it happen, hiring the best quality analysts!</h2>
                                <p class="marT15">Quality speaks value. And we take it as seriously as it gets while creating and offering solutions to our clients. To accomplish this we put up with precise approach and perfect processes of testing. And more than anything the best of QA resources to help us define and drive it well. That’s what makes us look for professionals who have that ability and aptitude to deliver quality with great commitment and authority.</p>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <ul>
                        ...
                        <li>
                            <div class="loc-col">
                                ...
                                <div class="location_Name">Department <span>Quality Analyst</span></div>
                            </div>
                        </li>
                        <li>
                            <div class="loc-col">
                                <span class="careerIcon jobtype_icon"></span>
                                <div class="location_Name">Job-Type <span>Full-Time</span></div>
                            </div>
                        </li>
                        <li>
                            <a href="cdn-cgi/l/email-protection.html#345c46745f5b5a4740555a405d5a525b1a575b59" class="apply_Now_btn">Apply Now</a>
                        </li>
                    </ul>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-sm-6">
                    <div class="duties">
                        ...
                        <ul>
                            <li>Execute and evaluate manual or automated test cases and report test results.</li>
                            <li>To communicate bugs to developers and other stakeholders</li>
                            <li>Review functional and design specifications to ensure complete understanding of individual deliverables.</li>
                            <li>Ensure that validated deliverables meet functional and design specifications and requirements.</li>
                            <li>Researching business opportunities to identify new leads and potential new markets</li>
                            <li>Identify project requirements and focus on deadlines and deliverables</li>
                            <li>Identify any potential quality issues as per defined process and escalate potential quality issues immediately to management.</li>
                        </ul>
                    </div>
                </div>
                <div class="col-sm-6">
                    <div class="duties">
                        ...
                        <ul>
                            <li>Should be proficient with using bug-tracking tools like JIRA, Bugzilla, Mantis, and Zoho</li>
                            <li>Familiar with the process of Load Testing, Security Testing, Bug Tracking, Functional Testing and Regression Testing</li>
                            <li>Should have knowledge of using QA tools like Selenium WebDriver, JMeter, Appium and Wapiti</li>
                            <li>Ability to comprehend and create test plans from specifications or verbal communications.</li>
                            <li>Hands-on experience with Quality Management Software and Processes</li>
                            <li>Ability to write test plans and test cases. </li>
                            <li>Should have keen eye for detail and can create clear, concise detail-oriented test plans/cases.</li>
                        </ul>
                    </div>
                </div>
            </div>
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            ...
                            <div class="col_bottom">
                                <a href="cdn-cgi/l/email-protection.html#3e564c7e5551504d4a5f504a57505851105d5153" class="apply_btn1 transition">Apply Now</a>
